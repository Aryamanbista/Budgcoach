                ...
                onPressed: () {
                  ...
                  if (amount != null && amount > 0) {
                    ref
                        ...
                        .addContribution(widget.goalId, amount);
                ...
                onPressed: () {
                  ...
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: const Text(
                        'Are you sure you want to permanently delete this savings goal?',
                      ),
                      actions: [
                        TextButton(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  _buildMetricRow(
                                    'Saved Amount',
                                    Formatters.formatNpr(goal.currentAmount),
                                    color: AppColors.primary,
                                  ),
                                  const Divider(),
                                  _buildMetricRow(
                                    'Target Goal',
                                    Formatters.formatNpr(goal.targetAmount),
                                  ),
                                  const Divider(),
                                  _buildMetricRow(
                                    'Remaining Needed',
                                    Formatters.formatNpr(
                                      goal.remainingAmount.clamp(
                                        0.0,
                                        goal.targetAmount,
                                      ),
                                    ),
                            ...
                            Card(
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  final contribution =
                                      goal.contributionHistory[index];
                                  return ListTile(
                                    leading: const Icon(
                                      Icons.add_circle,
                                      color: AppColors.primary,
