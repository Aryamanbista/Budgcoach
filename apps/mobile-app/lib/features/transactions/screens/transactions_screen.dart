...
class _TransactionsScreenState extends ConsumerState<TransactionsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredTxs = allTxs.where((tx) {
      ...
      // Category filter
      if (_filters.selectedCategories.isNotEmpty && !_filters.selectedCategories.contains(tx.category)) {
        return false;
      }
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Badge(
              isLabelVisible: _filters.selectedCategories.isNotEmpty || _filters.dateRange != 'All',
